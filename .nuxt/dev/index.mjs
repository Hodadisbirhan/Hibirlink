...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getCookie, setCookie, getRequestPath, getRequestHeaders, getHeader, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/devalue/index.js';
import destr from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/scule/dist/index.mjs';
import defu, { defuFn, createDefu } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/consola/dist/index.mjs';
import devalue from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/unctx/dist/index.mjs';
import * as csrf from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/uncsrf/dist/csrf.node.mjs';
import { importEncryptSecret } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/uncsrf/dist/csrf.node.mjs';
import chalk from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/chalk/source/index.js';
import { HtmlValidate, formatterFactory } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/html-validate/dist/es/index.js';
import { version, unref } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/hodadis/hibirlink-2024/hibirlink/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/hodadis/hibirlink-2024/hibirlink","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/hodadis/hibirlink-2024/hibirlink/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/hodadis/hibirlink-2024/hibirlink/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/hodadis/hibirlink-2024/hibirlink/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/hodadis/hibirlink-2024/hibirlink/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _0XgWy6GbIq = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/home/hodadis/hibirlink-2024/hibirlink";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _Y8C4LuCp4h = (nitroApp) => {
...
const _eSKkuCpjjy = defineNitroPlugin((nitroApp) => {
...
const useChecker = (validator, usePrettier = false, logLevel = "verbose") => {
  ...
  const checkHTML = async (url, html) => {
    ...
    try {
      if (usePrettier) {
        const { format } = await import('file:///home/hodadis/hibirlink-2024/hibirlink/node_modules/prettier/index.mjs');
...
const _uCysMO0hcp = (function(nitro) {
...
const _dRjqR1 = defineEventHandler(async (event) => {
...
const _lazy_B1M9Qf = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_B1M9Qf, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _dRjqR1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_B1M9Qf, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///home/hodadis/hibirlink-2024/hibirlink/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/hodadis/hibirlink-2024/hibirlink/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
